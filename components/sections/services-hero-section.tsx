    ...
    <section className="relative overflow-hidden px-4 pb-20 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
        ...
        <h1 className="text-balance text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl">
          Practical website packages designed for small businesses
        </h1>
        <p className="text-balance text-lg text-muted-foreground sm:text-xl">
          From first website builds to ongoing care, we move at your pace and explain every step in
          plain language.
        </p>
        <Link href="/contact">
          <Button
        ...
        <span className="mt-2 text-balance text-sm text-muted-foreground">
          I reply within one business day with next steps.
        </span>
      </div>
    </section>
  );
